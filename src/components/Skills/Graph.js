...
const Graph = () => {
  ...
  x = stats.percentile * 6.5 + 115 + "px";
  
  if (stats.percentile === "100") {
    y = "789.6px";
  }
  else {
    y = (Math.floor(stats.percentile / 20)) * 131.4 + 264 + "px";
  }

  //dynamically changing the blue dot.
  z = stats.percentile * 6.5 + 261.5 + "px";

  a = stats.percentile * 6.5 + 280;

  return (
    <div className="graph">
      <div className="graphContents">
        <div className="graphTexts">
        <h6>Comparison Graph</h6>
          <p><span>You scored {stats.percentile}% percentile</span> {stats.percentile < 72 ? ("which is lower than the") : ("which is higher than the")} </p>
      ...
      <div className="graphChart">
        ...
        <div className="blueDiv">
          <hr style={{ left: x }} className='bluex' />
        ...
        <div className="black">
          ...
          <div style={{ left: a + 15 + "px" }} className="blackDiv">
            <h6>{stats.percentile}% Percentile</h6>
            <p>Your score</p>
          </div>
        </div>
      </div>
...
{/* <div className="comparison-graph">
      <div className="graph-head">
        <CardHeading heading="Comparison Graph" />
        <div className="head-graph">📈</div>
      </div>
      <div className="graph-main">

        <div className="main-content">
          <b>You scored {stats.percentile}% percentile</b> {stats.percentile < 72 ? ("which is lower ") : ("which is higher ")}than average percentile 72% of all the engineers who took this assessment
        </div>
